...
class AtomicUInt8Tests: XCTestCase {
    static var allTests = [
    ...
    var atomicTests = AtomicTests<AtomicUInt8>()

    var atomicArithmeticTests = AtomicArithmeticTests<AtomicUInt8>()

    var atomicBitwiseTests = AtomicBitwiseTests<AtomicUInt8>()
