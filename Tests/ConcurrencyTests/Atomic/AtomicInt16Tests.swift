...
class AtomicInt16Tests: XCTestCase {
    static var allTests = [
    ...
    var atomicTests = AtomicTests<AtomicInt16>()

    var atomicArithmeticTests = AtomicArithmeticTests<AtomicInt16>()

    var atomicBitwiseTests = AtomicBitwiseTests<AtomicInt16>()
