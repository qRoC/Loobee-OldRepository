...
class AtomicInt64Tests: XCTestCase {
    static var allTests = [
    ...
    var atomicTests = AtomicTests<AtomicInt64>()

    var atomicArithmeticTests = AtomicArithmeticTests<AtomicInt64>()

    var atomicBitwiseTests = AtomicBitwiseTests<AtomicInt64>()
