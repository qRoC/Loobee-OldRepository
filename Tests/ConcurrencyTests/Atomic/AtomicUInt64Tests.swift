...
class AtomicUInt64Tests: XCTestCase {
    static var allTests = [
    ...
    var atomicTests = AtomicTests<AtomicUInt64>()

    var atomicArithmeticTests = AtomicArithmeticTests<AtomicUInt64>()

    var atomicBitwiseTests = AtomicBitwiseTests<AtomicUInt64>()
