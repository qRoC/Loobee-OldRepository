...
class AtomicUInt32Tests: XCTestCase {
    ...
    var atomicTests = AtomicTests<AtomicUInt32>()

    var atomicArithmeticTests = AtomicArithmeticTests<AtomicUInt32>()

    var atomicBitwiseTests = AtomicBitwiseTests<AtomicUInt32>()
