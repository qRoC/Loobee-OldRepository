...
class AtomicInt32Tests: XCTestCase {
    ...
    var atomicTests = AtomicTests<AtomicInt32>()

    var atomicArithmeticTests = AtomicArithmeticTests<AtomicInt32>()

    var atomicBitwiseTests = AtomicBitwiseTests<AtomicInt32>()
